...
const { transformAsync } = babelCore as any
...
export type CallRule = {
  call: {
    ...
    match: {
       ...
       * - Plain string: matches function name directly (e.g., 'template')
       * - Import string: 'import:source:exportName' (e.g., 'import:solid-js/web:template')
       */
 ...
 *
 * @example
 * // template: replace children prop with null
 * {
 *   call: {
 *     match: {
 *       function: 'template',
